...
CROSSTABS
  /TABLES= Mig_type1 BY p22_activity_status by batch_state_region 
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p15_duration_of_residence_binned BY p04_sex by batch_state_region 
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES= p15_duration_of_residence_binned BY p05_age_binned by batch_state_region 
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT
  /COUNT ROUND CELL.
...
CROSSTABS
  /TABLES=  p15_duration_of_residence_binned BY p21_highest_grade_c7 by batch_state_region 
  /FORMAT=AVALUE TABLES
  /CELLS=COUNT
  /COUNT ROUND CELL.
