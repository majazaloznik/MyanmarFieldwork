...
FREQUENCIES VARIABLES = N147
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q52_C1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q52_D1
  /BARCHART FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES = Q53_A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_A_1_COWS
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_A_2_COWS
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_A_3_COWS
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q53_B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_B_1_BUFFALOES
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_B_2_BUFFALOES
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_B_3_BUFFALOES
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q53_d
  /BARCHART FREQ
  /ORDER=ANALYSIS.



FREQUENCIES VARIABLES = Q54_A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_A_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_A_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_a_3
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q54_b
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_b_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_b_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_b_3
  /BARCHART FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES = Q54_c_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.



FREQUENCIES VARIABLES = Q54_d
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_d_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_d_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q54_e
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_e_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_e_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_e_3
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q54_f
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_f_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_f_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q54_g
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_g_1
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_g_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_g_3
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q54_H
  /BARCHART FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES = Q56_C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q56_D
  /BARCHART FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES = N150
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q57A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q57B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q57C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q57D
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q58A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q58B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q58C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q58D
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q59A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q59B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q59C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q59D
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q59E
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q60A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q60B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q60C
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q60D
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q60E
  /BARCHART FREQ
  /ORDER=ANALYSIS.


FREQUENCIES VARIABLES = Q61A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q61B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q62A
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q62B
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = MODULE_4_2
  /BARCHART FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES = Q63_CROP_02
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q63_CROP_03
  /BARCHART FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = Q63_CROP_04
  /BARCHART FREQ
  /ORDER=ANALYSIS.

dataset copy pesticides.
dataset activate pesticides.

varstocases
  /make N151_Q63_crop_name from Q63_CROP_01 Q63_CROP_02 Q63_CROP_03 Q63_CROP_04
  /make N151_Q63_days from Q63_1_Crop_1 to Q63_1_Crop_4
   /make N151_Q63_Pesticide1 Q63_2_1_Crop_1 Q63_2_1_Crop_2 Q63_2_1_Crop_3 Q63_2_1_Crop_4
  /make N151_Q63_Pesticide2 Q63_2_2_Crop_1 Q63_2_2_Crop_2 Q63_2_2_Crop_3 Q63_2_2_Crop_4
  /make N151_Q63_Pesticide3 Q63_2_3_Crop_1 Q63_2_3_Crop_2 Q63_2_3_Crop_3 Q63_2_3_Crop_4  
  /make N151_Q63_Pest1 Q63_3_1_Crop_1 Q63_3_1_Crop_2 Q63_3_1_Crop_3 Q63_3_1_Crop_4
  /make N151_Q63_Pest2 Q63_3_2_Crop_1 Q63_3_2_Crop_2 Q63_3_2_Crop_3 Q63_3_2_Crop_4
  /make N151_Q63_Pest3 Q63_3_3_Crop_1 Q63_3_3_Crop_2 Q63_3_3_Crop_3 Q63_3_3_Crop_4
  /make N151_Q63_Pest4 Q63_3_4_Crop_1 Q63_3_4_Crop_2 Q63_3_4_Crop_3 Q63_3_4_Crop_4
  /make N151_Q63_saw from Q63_4_1_CROP_1 Q63_4_1_CROP_2 Q63_4_1_CROP_3 Q63_4_1_CROP_4
  /make N151_Q63_ag_s from Q63_4_2_CROP_1 Q63_4_2_CROP_2 Q63_4_2_CROP_3 Q63_4_2_CROP_4
  /make N151_Q63_fr from Q63_4_3_CROP_1 Q63_4_3_CROP_2 Q63_4_3_CROP_3 Q63_4_3_CROP_4
  /make N151_Q63_pre from Q63_4_4_CROP_1 Q63_4_4_CROP_2 Q63_4_4_CROP_3 Q63_4_4_CROP_4
 /index = CROPID
 /keep QUESTION_no MODULE_4_2 to Q63_4_4_Crop_4.

variable labels N151_Q63_crop_name "N151_Q63_crop_name  Name of crop on which pesticides were used in last growing season ".

FREQUENCIES VARIABLES = N151_Q63_crop_name
  /BARCHART FREQ
  /ORDER=ANALYSIS.

VARSTOCASES    
/make N152_Q63_Pesticide N151_Q63_Pesticide1 N151_Q63_Pesticide2 N151_Q63_Pesticide3
 /index = PEST_ID.


variable labels N151_Q63_days "N151_Q63_days- How many days after transplant did you spray".

FREQUENCIES VARIABLES =   N151_Q63_days
  /HISTOGRAM FREQ
  /ORDER=ANALYSIS.

variable labels  N151_Q63_saw "N151_Q63_saw Why did you spray?: {Saw pests in the field}".

FREQUENCIES VARIABLES =  N151_Q63_saw
  /barchart FREQ
  /ORDER=ANALYSIS.

variable labels  N151_Q63_ag_s "N151_Q63_ag_s - Why did you spray?: {Advice from agricultural services}".

FREQUENCIES VARIABLES =  N151_Q63_ag_s
  /barchart FREQ
  /ORDER=ANALYSIS.


variable labels  N151_Q63_fr "N151_Q63_fr Why did you spray?: {Suggested by friends/neighbours}".

FREQUENCIES VARIABLES = N151_Q63_fr
  /barchart FREQ
  /ORDER=ANALYSIS.

variable labels  N151_Q63_pre "N151_Q63_pre Why did you spray?: {Preventative spraying}".

FREQUENCIES VARIABLES =   N151_Q63_pre
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES = N152_Q63_Pesticide
  /barchart FREQ
  /ORDER=ANALYSIS.

SORT CASES by question_NO.

CASESTOVARS 
/id question_no cropid
/index = PEST_ID.

VARSTOCASES    
/make N153_Q63_Target N151_Q63_Pest1 N151_Q63_Pest2 N151_Q63_Pest3
 /index = PEST_ID.

variable labels N153_Q63_Target  "N153_Q63_Target - Which pest were you targeting? ".
FREQUENCIES VARIABLES =   N153_Q63_Target
  /barchart FREQ
  /ORDER=ANALYSIS.
...
FREQUENCIES VARIABLES =   Q64_A
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q64_B
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q64_C
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q64_D
  /barchart FREQ
  /ORDER=ANALYSIS.



FREQUENCIES VARIABLES =   Q65_A
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q65_B
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q65_C
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q65_D
  /barchart FREQ
  /ORDER=ANALYSIS.



FREQUENCIES VARIABLES =   Q66_A
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q66_B
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q66_C
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q66_D
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q67_A
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q67_B
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q67_C
  /barchart FREQ
  /ORDER=ANALYSIS.

FREQUENCIES VARIABLES =   Q67_D
  /barchart FREQ
  /ORDER=ANALYSIS.
